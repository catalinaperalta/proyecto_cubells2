...
class MateriaControllerTest < ActionController::TestCase
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post :create, materium: { codma: @materium.codma, horas_semanales: @materium.horas_semanales, nombre: @materium.nombre, requerimiento: @materium.requerimiento }
    end
  ...
  test "should update materium" do
    patch :update, id: @materium, materium: { codma: @materium.codma, horas_semanales: @materium.horas_semanales, nombre: @materium.nombre, requerimiento: @materium.requerimiento }
    assert_redirected_to materium_path(assigns(:materium))
  end
