class Actividad < ActiveRecord::Base
	...
	validates :calificacion, presence: false , numericality: {greater_than_or_equal_to: 0, less_than_or_equal_to: 100, only_integer: true, message: "Solo numeros enteros superiores a 0 y menores a 101"}
